...
import {berSatAllProducts} from '../helpers/berSatProducts';
import DeleteIcon from '../assets/delete_icon.png';

const BersatCartItemComponent = ({item}) => {
  ...
  const productImage = berSatAllProducts.find(p => p.name === item.name)?.image;
...
export default BersatCartItemComponent;
